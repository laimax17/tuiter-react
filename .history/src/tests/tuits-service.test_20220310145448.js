...
describe('can retrieve all tuits with REST API', () => {
  ...
  test("can retrieve all tuits with REST API", async() => {
    const newUser1 = newUsers[0];
    const newUser2 = newUsers[1];
    const newUser3 = newUsers[2];
    ...
    const retrieveTuit1 = allTuits.filter((x) => x.postedBy === newUser1._id);
    const retrieveTuit2 = allTuits.filter((x) => x.postedBy === newUser2._id);
    const retrieveTuit3 = allTuits.filter((x) => x.postedBy === newUser3._id);
