...
describe('can retrieve all tuits with REST API', () => {
  ...
  test("can retrieve all tuits with REST API", async() => {
    ...
    console.log(newUser2[0]._id);
    console.log(newUser3[0]._id);
    const retrieveTuit1 = allTuits.filter((x) => x.postedBy === newUser1[0]);
    const retrieveTuit2 = allTuits.filter((x) => x.postedBy  === newUser2[0]);
    const retrieveTuit3 = allTuits.filter((x) => x.postedBy  === newUser3[0]);
